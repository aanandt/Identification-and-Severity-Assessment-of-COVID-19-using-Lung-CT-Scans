...
df.to_csv('ClassificationResults/Test_result_LDCT_'+feature_extractor+'.csv')
...
plt.show()
plt.savefig('ClassificationResults/confusionmatrix_'+ 'LDCT_'+feature_extractor+'.png')

skplt.metrics.plot_roc_curve(gt_label.argmax(axis=1), pred_patients)
plt.show()
plt.savefig('ClassificationResults/roc_curve_LDCT_'+feature_extractor+ '.png')
